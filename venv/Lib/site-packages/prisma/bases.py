...
class BaseGeneratedFile(_PrismaModel):
    __prisma_model__: ClassVar[Literal['GeneratedFile']] = 'GeneratedFile'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.GeneratedFileActions[_PrismaModelT]':
        from .client import get_client

        return actions.GeneratedFileActions[_PrismaModelT](client or get_client(), cls)


class BaseGeneratedExcel(_PrismaModel):
    __prisma_model__: ClassVar[Literal['GeneratedExcel']] = 'GeneratedExcel'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.GeneratedExcelActions[_PrismaModelT]':
        from .client import get_client

        return actions.GeneratedExcelActions[_PrismaModelT](client or get_client(), cls)
